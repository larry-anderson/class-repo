...
myPersevereCodeObj.cumulativeScore += myPersevereCodeObj.cumulativeScore; 
...
mrAnderson.address.push('726');
mrAnderson.address.push('Metler');
mrAnderson.address.push('Drive');
...
const newObject = {
  ...
  person: false,
  age: 45629,
  skills: ['hunting', 'fishing', 'starting fires', 'makeing weapons']
}
