...
const newArray = [...[99], ...fibonacciNumbers, ...[34, 26]];
...
let myNewArray = ["cars", "boats", "planes", "trains", "motorcycles"];
...
newEmptyArray.push('mine', 'yours', 'ours')

console.log(newEmptyArray)

newEmptyArray.unshift('his', 'hers')
...
let sliceArray = [];
for(let i = 0; i < students.length; i++){
  sliceArray = students.slice(3, 11);
}
